...
public class Imovel {
	private int matricula_imo, valor_imo;
	private String rua_imo, cep_imo, bairro_imo, cidade_imo, uf_imo, tamanho_imo, comodos_imo, garagem_imo, tipo_imo, status_imo;
